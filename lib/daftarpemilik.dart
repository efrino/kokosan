...
class DaftarAsPemilik extends StatefulWidget {
  @override
  _DaftarAsPemilikState createState() => _DaftarAsPemilikState();
}

class _DaftarAsPemilikState extends State<DaftarAsPemilik> {
